#!/bin/bash
# FlashVstream evaluation script for StreamingGaze - Updated format
...
FLASH_VSTREAM_DIR="${FLASH_VSTREAM_PATH:-path/to/Flash-VStream}"
export PYTHONPATH="$ROOT_DIR:$FLASH_VSTREAM_DIR"
export DECORD_EOF_RETRY_MAX=40960  # Increase EOF retry limit for problematic videos
# ===== MODEL CONFIGURATION =====
MODEL_NAME="FlashVstream"
EVAL_NAME="FlashVstream"
# ===============================
WORKDIR="$ROOT_DIR/results/FlashVstream"
...
echo "========================================="
if [ $FAILED -eq 0 ]; then
    echo "✓ All FlashVstream evaluations completed successfully!"
