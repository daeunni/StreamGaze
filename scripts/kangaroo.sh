#!/bin/bash
# Kangaroo evaluation script for StreamingGaze
...
EVAL_NAME="Kangaroo"
# ===============================
WORKDIR="$ROOT_DIR/results/Kangaroo"
...
PAST_TASKS=(
    # "past_non_fixated_object_identification.json"  # Only the failed one
)
...
FUTURE_TASKS=(
    # "present_future_action_prediction.json"  # Failed due to GPU bug
)
...
echo "========================================="
if [ $FAILED -eq 0 ]; then
    echo "✓ All Kangaroo evaluations completed successfully!"
