#!/bin/bash
## --> Gemini 2.0 Flash model evaluation via GCP Vertex AI
...
# ===== MODEL CONFIGURATION =====
MODEL_NAME="Gemini"  # Using Gemini 2.0 Flash via GCP Vertex AI
EVAL_NAME="Gemini2.0Flash"
# ===============================
WORKDIR="$ROOT_DIR/results/Gemini"
# WORKDIR="$ROOT_DIR/workdir/Gemini/streamgaze_eval_final_text/$EVAL_NAME"
# WORKDIR="$ROOT_DIR/workdir/Gemini/streamgaze_eval_final_salience/$EVAL_NAME"
...
# Launch tasks with concurrency limit (1 at a time to avoid Vertex AI quota limits)
PIDS=()
MAX_PARALLEL=1
echo ""
