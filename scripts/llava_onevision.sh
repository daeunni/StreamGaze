#!/bin/bash
# LLaVA-OneVision evaluation script for StreamingGaze
...
# ===== MODEL CONFIGURATION =====
MODEL_NAME="LLaVAOneVision"  # Using LLaVA-OneVision-7B
EVAL_NAME="LLaVA-OneVision-7B"
# ===============================
WORKDIR="$ROOT_DIR/results/LLaVAOneVision"
...
echo "========================================="
if [ $FAILED -eq 0 ]; then
    echo "✓ All LLaVA-OneVision evaluations completed successfully!"
