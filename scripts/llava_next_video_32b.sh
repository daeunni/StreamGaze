#!/bin/bash
# LLaVA-NeXT-Video-32B evaluation script for StreamingGaze
...
# ===== MODEL CONFIGURATION =====
MODEL_NAME="LLaVANextVideo32"  # Using LLaVA-NeXT-Video-32B
EVAL_NAME="LLaVA-NeXT-Video-32B"
# ===============================
WORKDIR="$ROOT_DIR/results/LLaVANextVideo32"
...
echo "========================================="
if [ $FAILED -eq 0 ]; then
    echo "✓ All LLaVA-NeXT-Video-32B evaluations completed successfully!"
