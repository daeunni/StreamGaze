#!/bin/bash
# MiniCPM-V evaluation script for StreamingGaze
...
# ===== MODEL CONFIGURATION =====
MODEL_NAME="MiniCPMV"
EVAL_NAME="MiniCPM-V-2.6"
# ===============================
WORKDIR="$ROOT_DIR/results/MiniCPMV"
...
echo "========================================="
if [ $FAILED -eq 0 ]; then
    echo "✓ All MiniCPM-V evaluations completed successfully!"
